...
<div class="col-lg-12">
    <div class="panel panel-default">
        <div class="panel-heading">
            Editar Archivos de la página Inicio
        </div>
...
{% for (var i=0, file; file=o.files[i]; i++) { %}
    <tr id="item-{%=file.pos%}" data-num-id="{%=file.id%}"  class="template-download fade" data-pos="{%=file.pos%}">
        ...
        <td>
            <span class="title edit-title" data-url="{%=file.modifyUrl%}/title/{%=file.id%}">{%=(file.title)%}</span>
        </td>
         <td>
            <span class="descr edit-desc" data-url="{%=file.modifyUrl%}/description/{%=file.id%}">{%=(file.description)%}</span>
        </td>
         <td>
